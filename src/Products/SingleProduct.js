    ...
    <div className="md:flex justify-center dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="flex pt-6">
        <div className="px-5 pb-5">
          ...
          <h1 className="font-bold dark:text-white">Description: </h1>
          <p className="dark:text-white">{location.state.description}</p>
          <div className="my-4">
          ...
          <div className="flex  justify-between items-end">
            <Link
              to="/"
              className="bg-red-500 hover:bg-red-600 px-5 py-2 text-sm text-white uppercase mt-3"
            >
              Back
            </Link>
          </div>
