...
<section className="relative z-10 overflow-hidden px-10 bg-white py-20 lg:py-[120px]">
<div>
    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12" data-aos="fade-right">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          ...
          <h2
            className="text-dark mb-6 text-3xl font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">(+88)01799999999</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">aturjoy4@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
